...
<%
	String success="", error="";
   	...
   	if(request.getParameter("submit")!=null){
      	...
      	ResultSet sel=con.createStatement().executeQuery("select * from customer where cust_email='"+email+"' and cust_phone	='"+phone+"'");
      	if(sel.next()){
      		
      		con.createStatement().executeUpdate("update customer set cust_pwd='"+pass+"' where cust_email='"+email+"'");
			success = "Customer password reset successful";
      	}
      	else {
		...
		<div class="container">
			<div class="row m-5 no-gutters shadow-lg">
				<div class="col-md-6 d-none d-md-block">
					<img src="images/customer-login.png" class="img-fluid" style="min-height:100%;" />
				</div>

				<div class="col-md-6 bg-white p-5">
					<h3 class="pb-3"><b>CUSTOMER RESET PASSWORD</b></h3>
