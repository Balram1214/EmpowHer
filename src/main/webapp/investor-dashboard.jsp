...
<head>
    <meta charset="utf-8">
    <title>EmpowHer - Investor Dashboard</title>
...
<%
	String result ="SELECT count(*) FROM seller where seller_is_active=1";
...
%>
                            ...
                            <a class="card-footer text-white clearfix small z-1" href="investor-view-sellers.jsp">
...
%>
                            ...
                            <a class="card-footer text-white clearfix small z-1" href="investor-view-category.jsp">
                                <span class="float-left">View Details</span>
                                <span class="float-right">
                                    <i class="fas fa-angle-right"></i>
                                </span>
...
%>
                            ...
                            <a class="card-footer text-white clearfix small z-1" href="investor-view-old-products.jsp">
                                <span class="float-left">View Details</span>
                                <span class="float-right">
                                    <i class="fas fa-angle-right"></i>
                                </span>
...
<%
	result = "SELECT count(*) FROM messages2 where receiver_id="+session.getAttribute("iid");
    rs = con.createStatement().executeQuery(result);
    rs.next();
    int messages = rs.getInt(1);
%>
                                <div class="mr-5"><span class="badge badge-danger"><%=messages%></span> Inbox</div>
                            </div>
                            <a class="card-footer text-white clearfix small z-1" href="investor-view-inbox.jsp">
                                <span class="float-left">View Details</span>
                                <span class="float-right">
                                    <i class="fas fa-angle-right"></i>
                                </span>
