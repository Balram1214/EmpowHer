...
<%
	String success="", error="";
   	...
   	if(request.getParameter("submit")!=null){
      	...
      	ResultSet sel=con.createStatement().executeQuery("select * from admin where admin_email='"+email+"' and admin_phone	='"+phone+"'");
      	if(sel.next()){
      		
      		con.createStatement().executeUpdate("update admin set admin_pwd='"+pass+"' where admin_email='"+email+"'");
		...
		<div class="container">
			<div class="row m-5 no-gutters shadow-lg">
				...
				<div class="col-md-6 bg-white p-5">
					<h3 class="pb-3"><b>ADMIN RESET PASSWORD</b></h3>
