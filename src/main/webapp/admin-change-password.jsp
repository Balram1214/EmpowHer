	...
	String succ="", err="";
  	...
  	if(request.getParameter("change_pwd")!=null){
		int aid = Integer.parseInt(session.getAttribute("aid").toString());
  		...
  		PreparedStatement ps = con.prepareStatement("select * from admin where admin_pwd=? and admin_id=?");
  		...
  		if(rs.next()){
			if(npass.equals(cpass)){
	  			ps = con.prepareStatement("UPDATE admin SET admin_pwd = ? WHERE admin_id = ?");
