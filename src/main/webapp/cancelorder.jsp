...
<head>
	...
	<title>EmpowHer - Order Cancellation</title>
</head>
<body>
	<div style="margin-left:50px;">
<%  
	String orderid = request.getParameter("oid");
	ResultSet query = con.createStatement().executeQuery("select orderNumber,orderStatus from orders where order_id="+orderid);
	query.next();
%>
